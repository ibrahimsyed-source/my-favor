...
const s = StyleSheet.create({
  ...
  ctaLabel: { fontFamily: fonts.displayMedium, fontSize: 15, letterSpacing: 1, color: palette.white },
  secondaryBtn: {
    alignSelf: 'center',
    width: '100%',
    height: 46,
  ...
  modalTitle: { fontFamily: fonts.displayMedium, fontSize: 24, lineHeight: 36, color: palette.textPrimary, textAlign: 'center' },
  modalBody: {
    marginTop: 12,
    fontFamily: P_MED,
    fontSize: 16,
